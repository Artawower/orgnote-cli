...
import { HandlersHttpResponseArrayStringAny } from '../model/handlersHttpResponseArrayStringAny.js';
...
export class TagsApi {
     ...
     * @summary Get tags
     */
    public async tagsGet (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: HandlersHttpResponseArrayStringAny;  }> {
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: HandlersHttpResponseArrayStringAny;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "HandlersHttpResponseArrayStringAny");
